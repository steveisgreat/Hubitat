...
metadata {
    definition(name: "LIFX White", namespace: "sriley-claude", author: "Robert Alan Heyes", importUrl: 'https://raw.githubusercontent.com/steveisgreat/Hubitat/main/lifx/LIFXWhite.groovy') {
        capability "Bulb"
