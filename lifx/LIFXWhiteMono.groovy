...
metadata {
    definition(name: "LIFX White Mono", namespace: "sriley-claude", author: "Robert Alan Heyes", importUrl: 'https://raw.githubusercontent.com/steveisgreat/Hubitat/main/lifx/LIFXWhiteMono.groovy') {
        capability "Bulb"
        capability "Polling"
        capability "Switch"
