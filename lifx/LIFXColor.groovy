...
metadata {
    definition(name: "LIFX Color", namespace: "sriley-claude", author: "Robert Alan Heyes", importUrl: 'https://raw.githubusercontent.com/steveisgreat/Hubitat/main/lifx/LIFXColor.groovy') {
        capability "Bulb"
