...
metadata {
    definition(name: 'LIFX Tile', namespace: 'sriley-claude', author: 'Robert Alan Heyes', importUrl: 'https://raw.githubusercontent.com/steveisgreat/Hubitat/main/lifx/LIFXTile.groovy') {
        capability 'Light'
