 ...
 */
metadata {
    definition(name: 'LIFX Multizone', namespace: 'sriley-claude', author: 'Robert Alan Heyes', importUrl: 'https://raw.githubusercontent.com/steveisgreat/Hubitat/main/lifx/LIFXMultiZone.groovy') {
        capability 'Light'
