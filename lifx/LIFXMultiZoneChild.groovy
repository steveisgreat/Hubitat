...
metadata {
    definition(name: "LIFX Multizone Child", namespace: "sriley-claude", author: "David Kilgore", importUrl: 'https://raw.githubusercontent.com/steveisgreat/Hubitat/main/lifx/LIFXMultiZoneChild.groovy') {
        capability 'Light'
