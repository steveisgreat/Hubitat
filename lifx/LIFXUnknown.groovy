...
metadata {
    definition(name: "LIFX Unknown", namespace: "sriley-claude", author: "Robert Alan Heyes", importUrl: 'https://raw.githubusercontent.com/steveisgreat/Hubitat/main/lifx/LIFXUnknown.groovy') {
        capability "Bulb"
        capability "Polling"
        capability "Switch"
