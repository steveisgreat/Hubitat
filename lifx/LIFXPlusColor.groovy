...
metadata {
    definition(name: "LIFXPlus Color", namespace: "sriley-claude", author: "Robert Alan Heyes", importUrl: 'https://raw.githubusercontent.com/steveisgreat/Hubitat/main/lifx/LIFXPlusColor.groovy') {
        capability "Bulb"
